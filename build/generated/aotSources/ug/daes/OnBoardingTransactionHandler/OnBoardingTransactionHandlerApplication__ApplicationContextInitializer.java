 ...
 */
@Generated
public class OnBoardingTransactionHandlerApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new OnBoardingTransactionHandlerApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new OnBoardingTransactionHandlerApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
  ...
  private void addImportAwareBeanPostProcessors(DefaultListableBeanFactory beanFactory) {
    ...
    mappings.put("org.springframework.security.config.annotation.method.configuration.PrePostMethodSecurityConfiguration", "ug.daes.OnBoardingTransactionHandler.conf.SecurityConfig");
