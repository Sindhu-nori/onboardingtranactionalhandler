...
public class AuthorizationProxyConfiguration__BeanDefinitions {
  ...
  private static BeanInstanceSupplier<AuthorizationAdvisorProxyFactory> getAuthorizationProxyFactoryInstanceSupplier(
    ...
    return BeanInstanceSupplier.<AuthorizationAdvisorProxyFactory>forFactoryMethod(AuthorizationProxyConfiguration.class, "authorizationProxyFactory", ObjectProvider.class)
            .withGenerator((registeredBean, args) -> AuthorizationProxyConfiguration.authorizationProxyFactory(args.get(0)));
  }
